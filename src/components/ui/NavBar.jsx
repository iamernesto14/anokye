...
export default function NavBar({ sectionRefs }) {
  ...
  return (
    <header
      ref={navBar}
      className="top-0 z-50 md:flex w-full -translate-y-full items-start md:items-center justify-between bg-secondary-100 px-5 py-5"
    >
      {/* logo */}
      <a href="#hero" aria-label="Logo" className="z-50 cursor-pointer">
        <span>&copy; Code by Anokye</span>
      </a>
